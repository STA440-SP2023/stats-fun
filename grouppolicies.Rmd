...
- Designate a coordinator, recorder, reproducibility checker, and monitor/reviewer for each assignment. These should vary so that each group member takes a different role on a new assignment. Sometimes you'll be playing multiple roles!
- Agree on meeting times in advance and on what each member should have completed before the meetings (readings, initial analysis, coding, etc.).
- Do the required individual preparation.
- Coordinator sends reminder before meeting that includes virtual location, time, and individual preparation assignments
...
If a team member indicates each group member participated appropriately, but later voices a complaint that the work was not equally divided, then evaluations will be consulted (and if, at the time, you felt work was equally divided, then that will be used as strong evidence against your claim).  That is, it's not to your advantage to "be nice" and give everyone equal credit if it is not deserved.
