...
# Case Study Goals
 ...
 - Quantify relationships between various sociodemographic and geographic factors and risk of default
  - Quantify relationships between various sociodemographic and geographic factors and time to default (often censored)
...
-   Data for this case study are available on the STA 440L container as well as on Sakai. Note: you may access the the active Kiva API if you would like to explore more recent data
-   Additional data which provides regional or macroeconomic context may be included at your discretion
