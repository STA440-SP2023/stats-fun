---
title: "Survival: Proportional Hazards Models"
output: 
...
```{r survprob, warning=F, message=F, fig.height=4, fig.width=6}
library(survminer)
...
```{r cumprob, warning=F, message=F, fig.height=4, fig.width=6}
ggsurvplot(survfit(SurvObj ~ Sex, data = lung2), 
